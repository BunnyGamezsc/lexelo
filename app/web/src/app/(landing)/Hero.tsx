          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              <div className="inline-flex items-center gap-2 bg-white/90 backdrop-blur-[20px] px-4 py-2 rounded-full shadow-md mb-6">
                ...
                <span className="text-sm text-[#5A5A5A] font-medium">Trusted by 1 language learner (the dev btw)</span>
              </div>
              ...
              <p className="text-xl text-[#5A5A5A] mb-12 leading-relaxed max-w-2xl">
                Transform your Latin learning with in-depth practice, intelligent flashcards,
                and spaced repetition. From quick vocab to conjugations and more, see lasting progress towards your studies.
              </p>
              ...
              <div className="flex gap-12">
                <div className="text-center">
                  <div className="text-3xl font-bold bg-gradient-to-r from-[#B8945F] to-[#D4B896] bg-clip-text text-transparent">0</div>
                  <div className="text-sm text-[#8A8A8A]">Flashcards Reviewed</div>
                </div>
                <div className="text-center">
                  <div className="text-3xl font-bold bg-gradient-to-r from-[#B8945F] to-[#D4B896] bg-clip-text text-transparent">100%</div>
                  <div className="text-sm text-[#8A8A8A]">Retention Rate</div>
                </div>
                <div className="text-center">
                  <div className="text-3xl font-bold bg-gradient-to-r from-[#B8945F] to-[#D4B896] bg-clip-text text-transparent">5★</div>
              ...
              <div className="bg-white/90 backdrop-blur-[20px] rounded-3xl p-10 shadow-2xl border border-[rgba(212,185,150,0.3)] max-w-md mx-auto top-[-2rem] md:top-0 scale-92 md:scale-100 relative overflow-hidden animate-cardFloat">
                ...
                <div className="bg-(--lingua-grey) rounded-2xl p-6 mb-8">
                  ...
                  <div className="bg-[rgba(245,240,230,0.15)] rounded-xl p-4 border border-[rgba(212,185,150,0.3)]">
                    <p className="text-[#F5F0E6] italic mb-2">"appropinquaverant"</p>
                    <p className="text-[#D4B896] text-sm">They had approached</p>
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  <div className="flex justify-between items-center p-4 bg-[rgba(245,240,230,0.5)] rounded-xl hover:translate-x-2 transition-all duration-300">
                    <span className="text-[#5A5A5A] font-medium">Subjunctive Mastery</span>
                    <span className="font-bold text-lg text-[#10b981]">85%</span>
                  </div>
                  <div className="flex justify-between items-center p-4 bg-[rgba(245,240,230,0.5)] rounded-xl hover:translate-x-2 transition-all duration-300">
                    <span className="text-[#5A5A5A] font-medium">Chapter 6 Set</span>
                    <span className="font-bold text-lg text-[#3b82f6]">92% Complete</span>
                  </div>
                  <div className="flex justify-between items-center p-4 bg-[rgba(245,240,230,0.5)] rounded-xl hover:translate-x-2 transition-all duration-300">
                    <span className="text-[#5A5A5A] font-medium">Chapter 5 Practice Test #1</span>
                    <span className="font-bold text-lg text-[#8b5cf6]">18/20</span>
                  </div>
                </div>
              </div>
            </div>
