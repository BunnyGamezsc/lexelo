      ...
      <div className="max-w-7xl mx-auto px-8">
        <div className="bg-(--lingua-grey) rounded-3xl p-10 sm:p-16 text-center relative overflow-hidden">
          ...
          <p className="text-lg sm:text-xl text-[rgba(245,240,230,0.8)] mb-12 max-w-3xl mx-auto relative z-10 animate-fadeInUp">
           Be one of the first students to master Latin through intelligent, engaging practice
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8 relative z-10">
            ...
            <a href="#" className="bg-transparent text-[#F5F0E6] px-9 py-4 border-2 border-[#D4B896] rounded-full font-semibold text-lg text-center transition-all duration-300 hover:bg-[#D4B896] hover:text-(--lingua-grey) hover:translate-y-[-2px] hover-scale">
              Contribute
            </a>
          </div>
