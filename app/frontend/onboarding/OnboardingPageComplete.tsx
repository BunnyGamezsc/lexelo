    ...
    return (
        <div className={`text-center z-10 animate-slideInUp mt-auto ${goBack ? 'animate-bounceOut' : ''}`}>
            ...
            <p className="text-lg text-[#5A5A5A] mb-8 max-w-md mx-auto animate-fadeInUp animation-delay-300">
                Your personalized Latin learning journey is ready to begin. Let's start building your vocabulary!
            </p>
            ...
            <div className="max-w-md mx-auto mb-8 animate-fadeInUp animation-delay-500">
                <div className="bg-white/20 backdrop-blur-sm rounded-2xl p-6 shadow-lg">
                    <h3 className="text-xl font-semibold text-(--lingua-grey) mb-4">What's next?</h3>
                    <div className="space-y-3 text-left">
                        <div className="flex items-center gap-3">
                            <CheckCircle className="w-5 h-5 text-green-600" />
                            <span className="text-(--lingua-grey)">Start with your first lesson</span>
                        </div>
                        <div className="flex items-center gap-3">
                            <CheckCircle className="w-5 h-5 text-green-600" />
                            <span className="text-(--lingua-grey)">Practice with interactive flashcards</span>
                        </div>
                        <div className="flex items-center gap-3">
                            <CheckCircle className="w-5 h-5 text-green-600" />
                            <span className="text-(--lingua-grey)">Track your progress daily</span>
                        </div>
                        <div className="flex items-center gap-3">
                            <CheckCircle className="w-5 h-5 text-green-600" />
