...
export default function LandingPage4() {
  ...
  return (
    ...
    <div className="landing-container">
      {/* Navigation */}
      <nav className={`fixed top-0 left-0 right-0 bg-white/95 backdrop-blur-md z-50 transition-all duration-300 ${
        scrolled ? 'py-3 border-b border-gray-200 shadow-sm' : 'py-4 border-b border-transparent'
      }`}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between">
            <div className="flex flex-col">
              ...
              <span className="text-xs text-gray-600 -mt-1">Master Latin & Beyond</span>
            </div>
            <div className="hidden md:flex items-center space-x-8">
              ...
              <a href="#languages" className="text-gray-600 hover:text-purple-600 font-medium transition-colors">
                Languages
              </a>
              <a href="#pricing" className="text-gray-600 hover:text-purple-600 font-medium transition-colors">
                Pricing
              </a>
              <a href="#resources" className="text-gray-600 hover:text-purple-600 font-medium transition-colors">
                Resources
              </a>
            </div>
          ...
          <div className="lg:grid lg:grid-cols-2 lg:gap-8 items-center">
            <div className="relative z-10">
              <div className="inline-flex items-center gap-2 bg-white px-4 py-2 rounded-full shadow-md mb-6">
                ...
                <span className="text-sm text-gray-600 font-medium">Trusted by 50,000+ language learners</span>
              </div>
              <h1 className="text-5xl lg:text-6xl font-bold text-gray-900 leading-tight mb-6">
                Master Latin Grammar & Vocabulary
                <span className="bg-gradient-to-r from-purple-600 to-purple-800 bg-clip-text text-transparent"> the Smart Way</span>
              </h1>
              <p className="text-xl text-gray-600 mb-8 leading-relaxed">
                Transform your Latin learning with interactive lessons, intelligent flashcards, 
                and spaced repetition. From conjugations to complex texts, build lasting fluency 
                with our scientifically-proven approach.
              </p>
              ...
              <div className="flex gap-12">
                <div className="text-center">
                  <div className="text-3xl font-bold bg-gradient-to-r from-purple-600 to-purple-800 bg-clip-text text-transparent">2M+</div>
                  <div className="text-sm text-gray-600">Flashcards Reviewed</div>
                </div>
                <div className="text-center">
                  <div className="text-3xl font-bold bg-gradient-to-r from-purple-600 to-purple-800 bg-clip-text text-transparent">95%</div>
            ...
            <div className="hidden lg:block relative">
              <div className="relative w-full h-96">
                ...
                <div className="absolute -top-5 right-0 bg-white rounded-lg shadow-xl px-4 py-3 flex items-center gap-3 animate-float-delayed">
                  <span className="text-xl">📚</span>
                  <span className="text-sm text-gray-600">Dictionary: 5000+ words</span>
                </div>
                <div className="absolute bottom-10 left-0 bg-white rounded-lg shadow-xl px-4 py-3 flex items-center gap-3 animate-float-delayed-2">
                  <span className="text-xl">🔄</span>
                  <span className="text-sm text-gray-600">Spaced Repetition Active</span>
                </div>
              </div>
            </div>
          </div>
      ...
      <section id="features" className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">Everything You Need to Master Latin</h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="p-8 bg-white border border-gray-200 rounded-xl hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-3">Interactive Grammar Lessons</h3>
              <p className="text-gray-600 leading-relaxed">
                Master declensions, conjugations, and syntax through engaging exercises 
                that adapt to your learning pace and provide instant feedback.
              </p>
            </div>
            <div className="p-8 bg-white border border-gray-200 rounded-xl hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
              ...
              <p className="text-gray-600 leading-relaxed">
                Create custom decks or use pre-built sets. Our intelligent system tracks 
                your progress and schedules reviews for optimal retention.
              </p>
            </div>
            <div className="p-8 bg-white border border-gray-200 rounded-xl hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
              ...
              <p className="text-gray-600 leading-relaxed">
                Scientifically-proven algorithm ensures you review vocabulary at the 
                perfect intervals to move words from short to long-term memory.
              </p>
            </div>
            <div className="p-8 bg-white border border-gray-200 rounded-xl hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-3">Built-in Dictionary</h3>
              <p className="text-gray-600 leading-relaxed">
                Access our comprehensive Latin dictionary with detailed definitions, 
                conjugations, declensions, and etymology for over 5,000 words.
              </p>
            </div>
            <div className="p-8 bg-white border border-gray-200 rounded-xl hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
              ...
              <p className="text-gray-600 leading-relaxed">
                ...
                and personalized insights to keep you motivated.
              </p>
            </div>
            <div className="p-8 bg-white border border-gray-200 rounded-xl hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
              ...
              <p className="text-gray-600 leading-relaxed">
                Join or create study groups, share flashcard decks, and collaborate 
                with fellow learners to enhance your learning experience.
              </p>
            </div>
          </div>
        </div>
      ...
      {/* How It Works */}
      <section id="how-it-works" className="py-24 bg-gradient-to-br from-slate-50 to-purple-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">How Lexelo Works</h2>
            <p className="text-xl text-gray-600">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <div className="space-y-2">
                <h3 className="text-xl font-semibold text-gray-900">Choose Your Path</h3>
                <p className="text-gray-600 leading-relaxed">
                  Select your learning goals and current level. Whether you're a complete beginner or advancing your skills, we'll customize your experience.
                </p>
              </div>
            </div>
            <div className="text-center">
              ...
              <div className="space-y-2">
                <h3 className="text-xl font-semibold text-gray-900">Learn Interactively</h3>
                <p className="text-gray-600 leading-relaxed">
                  Engage with dynamic lessons that adapt to your pace. Practice grammar, expand vocabulary, and build confidence through varied exercises.
                </p>
              </div>
            </div>
            <div className="text-center">
              ...
              <div className="space-y-2">
                <h3 className="text-xl font-semibold text-gray-900">Review & Retain</h3>
                <p className="text-gray-600 leading-relaxed">
                  Our spaced repetition system ensures you review material at optimal intervals, moving knowledge from short-term to long-term memory.
                </p>
              </div>
            </div>
            <div className="text-center">
              ...
              <div className="space-y-2">
                ...
                <p className="text-gray-600 leading-relaxed">
                  Monitor your improvement with detailed analytics, celebrate milestones, and stay motivated with streaks and achievements.
                </p>
              </div>
            </div>
          </div>
      ...
      <section id="languages" className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">Expanding Your Language Journey</h2>
            <p className="text-xl text-gray-600">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="relative p-8 bg-white border-2 border-dashed border-gray-300 rounded-xl text-center hover:border-purple-600 hover:-translate-y-1 transition-all">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-2">Spanish Support</h3>
              <p className="text-gray-600">Complete Spanish curriculum with native audio pronunciation and cultural context.</p>
            </div>
            <div className="relative p-8 bg-white border-2 border-dashed border-gray-300 rounded-xl text-center hover:border-purple-600 hover:-translate-y-1 transition-all">
              <div className="absolute top-4 right-4 px-3 py-1 bg-gradient-to-r from-purple-600 to-purple-800 text-white text-xs font-semibold rounded-full">
                Coming Soon
              ...
              <div className="text-5xl mb-4">🇫🇷</div>
              <h3 className="text-xl font-semibold text-gray-900 mb-2">French Support</h3>
              <p className="text-gray-600">Comprehensive French learning path from basics to advanced conversation.</p>
            </div>
            <div className="relative p-8 bg-white border-2 border-dashed border-gray-300 rounded-xl text-center hover:border-purple-600 hover:-translate-y-1 transition-all">
              <div className="absolute top-4 right-4 px-3 py-1 bg-gradient-to-r from-purple-600 to-purple-800 text-white text-xs font-semibold rounded-full">
                In Development
              ...
              <div className="text-5xl mb-4">📖</div>
              <h3 className="text-xl font-semibold text-gray-900 mb-2">Reading Comprehension</h3>
              <p className="text-gray-600">Practice with authentic texts, interactive quizzes, and difficulty progression.</p>
            </div>
            <div className="relative p-8 bg-white border-2 border-dashed border-gray-300 rounded-xl text-center hover:border-purple-600 hover:-translate-y-1 transition-all">
              <div className="absolute top-4 right-4 px-3 py-1 bg-gradient-to-r from-purple-600 to-purple-800 text-white text-xs font-semibold rounded-full">
                In Development
              ...
              <div className="text-5xl mb-4">🔄</div>
              <h3 className="text-xl font-semibold text-gray-900 mb-2">Translation Tools</h3>
              <p className="text-gray-600">AI-powered translation assistance with grammar explanations and alternatives.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 bg-gradient-to-br from-slate-50 to-purple-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">Loved by Language Learners</h2>
            <p className="text-xl text-gray-600">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-xl shadow-lg">
              ...
              <p className="text-gray-600 italic mb-6 leading-relaxed">
                "Lexelo transformed my Latin studies. The spaced repetition system is incredibly 
                effective, and I've retained more vocabulary than with any other method."
              </p>
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg">
              <div className="text-yellow-400 text-xl mb-4">★★★★★</div>
              <p className="text-gray-600 italic mb-6 leading-relaxed">
                "As a Latin teacher, I recommend Lexelo to all my students. The grammar exercises 
                are perfectly structured and the progress tracking keeps them motivated."
              </p>
              <div className="flex items-center gap-4">
                <div className="w-12 h-12 bg-gradient-to-r from-purple-600 to-purple-800 rounded-full flex items-center justify-center text-white font-semibold">
                  MP
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg">
              <div className="text-yellow-400 text-xl mb-4">★★★★★</div>
              <p className="text-gray-600 italic mb-6 leading-relaxed">
                "The flashcard system is genius! I love how it adapts to my learning pace and 
                focuses on the words I struggle with most."
              </p>
              <div className="flex items-center gap-4">
                <div className="w-12 h-12 bg-gradient-to-r from-purple-600 to-purple-800 rounded-full flex items-center justify-center text-white font-semibold">
                  JL
            ...
            <div className="relative p-8 bg-white border-2 border-gray-200 rounded-xl">
              ...
              <ul className="space-y-4 mb-8">
                <li className="flex items-center gap-3">
                  ...
                  <span className="text-gray-600">Basic grammar exercises</span>
                </li>
                <li className="flex items-center gap-3">
                  <svg className="w-5 h-5 text-green-500 flex-shrink-0" viewBox="0 0 20 20" fill="currentColor">
                    <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                ...
                <li className="flex items-center gap-3">
                  ...
                  <span className="text-gray-600">Limited dictionary access</span>
                </li>
                <li className="flex items-center gap-3">
                  <svg className="w-5 h-5 text-green-500 flex-shrink-0" viewBox="0 0 20 20" fill="currentColor">
                    <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
            ...
            <div className="relative p-8 bg-white border-2 border-purple-600 rounded-xl transform scale-105">
              ...
              <ul className="space-y-4 mb-8">
                ...
                <li className="flex items-center gap-3">
                  ...
                  <span className="text-gray-600">Full dictionary access</span>
                </li>
                <li className="flex items-center gap-3">
                  <svg className="w-5 h-5 text-green-500 flex-shrink-0" viewBox="0 0 20 20" fill="currentColor">
                    <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
            ...
            <div className="relative p-8 bg-white border-2 border-gray-200 rounded-xl">
              ...
              <ul className="space-y-4 mb-8">
                ...
                <li className="flex items-center gap-3">
                  ...
                  <span className="text-gray-600">Shared flashcard decks</span>
                </li>
                <li className="flex items-center gap-3">
                  <svg className="w-5 h-5 text-green-500 flex-shrink-0" viewBox="0 0 20 20" fill="currentColor">
                    <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
      ...
      <section className="py-24 bg-gradient-to-r from-purple-600 to-purple-800 text-white text-center">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-xl mb-8 opacity-95">
            Join thousands of learners who've transformed their language skills with Lexelo
          </p>
          ...
          <p className="text-sm opacity-80">No credit card required • 14-day free trial of Pro features</p>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 mb-12">
            <div className="lg:col-span-1">
              ...
              <p className="text-gray-400 mb-6 leading-relaxed">
                Your comprehensive platform for mastering Latin and expanding to new languages.
              </p>
              <div className="flex space-x-4">
                <a href="#" aria-label="Twitter" className="w-10 h-10 bg-gray-800 rounded-full flex items-center justify-center hover:bg-purple-600 transition-colors">
                  <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
                    <path d="M23 3a10.9 10.9 0 01-3.14 1.53 4.48 4.48 0 00-7.86 3v1A10.66 10.66 0 013 4s-4 9 5 13a11.64 11.64 0 01-7 2c9 5 20 0 20-11.5a4.5 4.5 0 00-.08-.83A7.72 7.72 0 0023 3z" />
                  </svg>
                </a>
                <a href="#" aria-label="LinkedIn" className="w-10 h-10 bg-gray-800 rounded-full flex items-center justify-center hover:bg-purple-600 transition-colors">
                  <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
                    <path d="M16 8a6 6 0 016 6v7h-4v-7a2 2 0 00-2-2 2 2 0 00-2 2v7h-4v-7a6 6 0 016-6zM2 9h4v12H2z" />
                    <circle cx="4" cy="4" r="2" />
                  </svg>
                </a>
                <a href="#" aria-label="GitHub" className="w-10 h-10 bg-gray-800 rounded-full flex items-center justify-center hover:bg-purple-600 transition-colors">
                  <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
            ...
            <div>
              ...
              <ul className="space-y-3">
                ...
                <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Latin Guide</a></li>
