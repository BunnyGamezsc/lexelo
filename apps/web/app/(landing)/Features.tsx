      ...
      <div className="max-w-7xl mx-auto px-8">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          <div className="bg-white/70 backdrop-blur-[20px] rounded-2xl p-8 border border-[rgba(212,185,150,0.3)] transition-all duration-500 hover:translate-y-[-10px] hover:shadow-2xl relative overflow-hidden group hover-scale">
            ...
            <h3 className="text-xl font-bold text-[var(--lingua-grey)] mb-4 animate-slideInLeft">
          ...
          <div className="bg-[rgba(245,240,230,0.9)] backdrop-blur-[20px] rounded-2xl p-8 border border-[rgba(212,185,150,0.3)] transition-all duration-500 hover:translate-y-[-10px] hover:shadow-2xl relative overflow-hidden group shadow-xl hover-scale">
            ...
            <h3 className="text-xl font-bold text-[var(--lingua-grey)] mb-4 animate-slideInRight">
          ...
          <div className="bg-white/70 backdrop-blur-[20px] rounded-2xl p-8 border border-[rgba(212,185,150,0.3)] transition-all duration-500 hover:translate-y-[-10px] hover:shadow-2xl relative overflow-hidden group hover-scale">
            ...
            <h3 className="text-xl font-bold text-[var(--lingua-grey)] mb-4 animate-zoomIn">
