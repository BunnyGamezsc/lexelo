      ...
      <div className="max-w-7xl mx-auto px-8">
        <div className="flex items-center justify-between py-3">
          <div className="flex items-center gap-3 hover:scale-105 transition-transform duration-300">
            ...
            <span className="text-xl font-bold text-(--lingua-grey)">
              Lexelo
            </span>
          </div>
          ...
          <div className="hidden md:flex items-center gap-8">
            <a
              href="#features"
              className="text-[#5A5A5A] font-medium text-sm relative transition-all duration-300 hover:text-(--lingua-grey) after:content-[''] after:absolute after:bottom-[-6px] after:left-0 after:w-0 after:h-0.5 after:bg-[#B8945F] after:transition-all after:duration-300 hover:after:w-full"
            >
              Features
            </a>
            <a
